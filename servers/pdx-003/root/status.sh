...
'echo "&nbsp;&nbsp;Links: <a href='"'"'/satisfactory/1/start'"'"'>Start</a> | <a href='"'"'/satisfactory/1/simple'"'"'>Overview</a> | <a href='"'"'/satisfactory/1/logs'"'"'>Logs</a>"'
'echo ""'
...
'echo "&nbsp;&nbsp;Links: <a href='"'"'/satisfactory/2/start'"'"'>Start</a> | <a href='"'"'/satisfactory/2/simple'"'"'>Overview</a> | <a href='"'"'/satisfactory/2/logs'"'"'>Logs</a>"'
'echo ""'
...
'echo "&nbsp;&nbsp;Links: <a href='"'"'/satisfactory/3/start'"'"'>Start</a> | <a href='"'"'/satisfactory/3/simple'"'"'>Overview</a> | <a href='"'"'/satisfactory/3/logs'"'"'>Logs</a>"'
'echo ""')
