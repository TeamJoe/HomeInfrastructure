...
'echo ""'
'echo "<b>Mincraft Modern RLCraft 1.5.0 with NuclearCraft 2.18y-1.12.2</b>"'
...
'echo "&nbsp;&nbsp;Active: $(/home/minecraft/RLCraftServer.sh active)"'
...
'echo ""'
'echo "<b>Mincraft SkyFactory 4.2.2</b>"'
...
'echo "&nbsp;&nbsp;Active: $(/home/minecraft/SkyFactory4Server.sh active)"'
...
'echo ""'
'echo "<b>Mincraft SevTech: Ages 3.1.7</b>"'
...
'echo "&nbsp;&nbsp;Active: $(/home/minecraft/SevTechServer.sh active)"'
